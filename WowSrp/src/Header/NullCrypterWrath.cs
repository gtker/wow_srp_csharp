...
{
    /// <summary>
    ///     Encrypter/Decrypter that doesn't do anything for Wrath.
    ///     Used for reading the first messages sent by client and server.
    /// </summary>
    public class NullCrypterWrath : IServerDecrypter, IServerEncrypter, IClientDecrypter, IClientEncrypter
    {
